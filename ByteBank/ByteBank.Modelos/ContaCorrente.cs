...
{
    /// <summary>
    /// Define uma Conta correte do banco ByteBank
    /// </summary>
    public class ContaCorrente
    {
        ...
        /// <exception cref="ArgumentException">Em casos de erros com os parâmetros sera retornado ArgumentExceptions.</exception>
        ...
        /// <exception cref="ArgumentException">Exceção lançada quando um valor negativo é utilizado no arguemento <paramref name="valor"/>.</exception>
